...
dob varchar2(20),
raddressln1 varchar2(100),
raddressln2 varchar2(100),
landmark varchar2(50),
state varchar2(50),
city varchar2(50),
pincode number(6),
praddressln1 varchar2(100),
praddressln2 varchar2(100),
plandmark varchar2(50),
pstate varchar2(50),
pcity varchar2(50),
ppincode number(6),
occtype varchar2(50),
sourceincome varchar2(50),
...
userid references registerib(userid),
...
foreign key(refbeneficiaryaccno, refuserid) references beneficiarydetails (beneficiaryaccno,userid)
);
