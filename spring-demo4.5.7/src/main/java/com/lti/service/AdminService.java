...
public class AdminService 
{
	...
	public void getEmail()
	{
		...
		List<Admin> listofemails = adminDao.getEmail();
		ListIterator<Admin> iterator = listofemails.listIterator();
		while (iterator.hasNext())
		{
			/*
			 * Admin admin = (Admin) iterator.next(); String email = admin.getEmailid();
			 */
